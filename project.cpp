...
//system("tput clear");
system("cls");
cout<<"your balance is "<<n<<endl<<endl;
return n;
}
...
//exception handling for balance
...
int profitchecker(int curprof,int qprice )
{
  ...
  {
	  cout<<"Amount exceeds the profit value   (exception handeling)\n";
  }
	return q;
}
...
void profit()
{
cout<<"CURRENT PROFIT IS "<<prof<<"/-"<<endl<<endl;
}
};
